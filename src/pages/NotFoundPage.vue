...
.error-title {
  @apply text-8xl font-bold text-gradient-primary;
}

.error-subtitle {
  @apply text-3xl font-semibold text-secondary-800;
}

.error-description {
  @apply text-lg text-secondary-600 max-w-2xl mx-auto leading-relaxed;
}
